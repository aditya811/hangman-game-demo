window.onload = function() {
	var userGuess;
	var words = ["CAPTAINAMERICA","BLACKWIDOW","IORNMAN","BLACKPANTHER","BRUCEBANNER","SPIDERMAN"];
	var word = [];
	var positions = [];
	var guessedLetters = [];
	var guesses;
	...
	for (var i=0; i<=guesses; i++) {
		document.querySelector(".hangman").innerHTML += '<img class="guess' + i + '" src="assets/images/thanos' + i + '.png">';
		if (i != guesses) {
